...
Deploy the `backend/` app to a Python hosting platform such as Render, Railway, or Fly.io.
...
Deploy `frontend/` to Vercel, Netlify, or another static hosting provider.

If the API is not served from the same origin, set:
